...
<div class="row">
   <div class="col-sm-12">
      <div class="card">
         ...
         <div class="card-body">
         <form class="form-horizontal" method="post" action="{{ url('setup-store',$store->id) }}" enctype="multipart/form-data">
         @csrf
         @method('patch')
            <p>Enter information to update store</p>
            <div class="row">
               <div class="col-sm-4">
                  <p>Logo Store</p>
                  <div class="mt-2">
                  ...
                  <div>
                     <img id="preview" class="triggerButton" src="{{ $store->logo != null ? asset('storage/'.$store->logo) : asset('assets/images/browser_file.png') }}" style="width: 200px;">
                  </div>
               </div>
               <div class="col-sm-8">
               @if ($errors->any())
    ...
    @endif
                     <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                           <input type="text" class="form-control" id="text" name="name" value="{{ old('name', $store->name) }}" placeholder="Enter your store name">
                        </div>
                     </div>
                     <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                           <select name="user_id" id="user_id" class="form-control">
                              ...
                              <option value="{{$id}}" {{ $store->user_id == $id ? 'selected' : '' }}>{{$user}}</option>
                              @endforeach
                           </select>
                        </div>
                     </div>
                     <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                           <input type="text" class="form-control" id="text" name="facebook_link" value="{{ $store->facebook_link }}" placeholder="https://">
                        </div>
                     </div>
                     <div class="form-group row">
                        <label class="control-label col-sm-3 align-self-center mb-0">Instagram URL:</label>
                        <div class="col-sm-9">
                           <input type="text" class="form-control" id="text" name="instragram_link" value="{{ old('instragram_link', $store->instragram_link) }}" placeholder="https://">
                        </div>
                     </div>
                     <div class="form-group row">
                        <label class="control-label col-sm-3 align-self-center mb-0">Telegram URL:</label>
                        <div class="col-sm-9">
                           <input type="text" class="form-control" id="text" name="telegram_link" value="{{ old('telegram_link', $store->telegram_link) }}" placeholder="https://">
                        </div>
                     </div>
                     <div class="form-group row">
                        <label class="control-label col-sm-3 align-self-center mb-0">Phone Number:</label>
                        <div class="col-sm-9">
                           <input type="text" class="form-control" id="text" name="phone_number" value="{{ old('phone_number', $store->phone_number) }}" placeholder="+85500000000">
                        </div>
                     </div>
                     <div class="form-group row">
                        <label class="control-label col-sm-3 mb-0">Description:</label>
                        <div class="col-sm-9">
                           <textarea name="description" id="description" class="form-control" placeholder="Enter your description" rows="3">{{ old('description', $store->description) }}</textarea>
                        </div>
                     </div>
                     <div class="form-group row">
                        <label class="control-label col-sm-3 mb-0">Location:</label>
                        <div class="col-sm-9">
                           <textarea name="location" id="location" class="form-control" placeholder="Enter your location" rows="3">{{ old('location', $store->location) }}</textarea>
                        </div>
                     </div>

...
<div class="row">
   <div class="col-sm-12">
      <div class="card">
         ...
         @csrf
            <p>Enter information to create menus</p>
            <div class="row">
               <div class="col-sm-4">
                  <p>Photo Menu</p>
                  <div class="mt-2">
               ...
               @if ($errors->any())
                  ...
                  @endif
                     ...
                     <div class="form-group row">
                        <label class="control-label col-sm-3 align-self-center mb-0">Code:</label>
                        <div class="col-sm-9">
                           <input type="text" class="form-control" id="text" name="code" value="{{ old('code') }}" placeholder="Enter your code">
                        </div>
                     </div>
                     <div class="form-group row">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                           <input type="number" step="any" class="form-control" id="text" name="cost_usd" value="{{ old('cost_usd') }}" placeholder="0.00">
                        </div>
                     </div>
                     <div class="form-group row">
                        <label class="control-label col-sm-3 align-self-center mb-0">Cost KHR:</label>
                        <div class="col-sm-9">
                           <input type="number" step="any" class="form-control" id="text" name="cost_khr" value="{{ old('cost_khr') }}" placeholder="0.00">
                        </div>
                     </div>
                     <div class="form-group row">

...
<div class="row">
    <div class="col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
                <form class="form-horizontal" method="post" action="{{ url('users/'.$user->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <div>
                                <img id="preview" class="triggerButton" src="{{ $user->photo_url ? asset('storage/'.$user->photo_url) : asset('assets/images/browser_file.png') }}" style="width: 200px;">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-8">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="text" name="name" value="{{ $user->name }}" placeholder="Enter your name">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="control-label col-sm-3 align-self-center mb-0" for="text">Email:</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="text" name="email" value="{{ $user->email }}" placeholder="Enter your email">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="role_id" id="role_id" class="form-control">
                                        ...
                                        <option value="2" {{ $user->role_id == 2 ? 'selected' : '' }}>Store Admin</option>
                                    </select>
                                    @error('role')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="checkbox" class="form-check-input" id="text" name="is_active" value="1" {{ $user->is_active == 1 ? 'checked' : '' }}>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-9">
